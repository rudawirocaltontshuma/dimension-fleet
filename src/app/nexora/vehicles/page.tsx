...
import { driverName, locationName, VEHICLES } from "@/lib/nexora/generate";
import type { Vehicle } from "@/lib/nexora/types";
...
const columns: ColumnDef<Vehicle>[] = [
  {
    ...
    cell: (v) => (
      <Link href={`/nexora/vehicles/${v.id}`} className="font-medium hover:underline">
