...
import { TODAY_ISO } from "@/lib/nexora/constants";
import { fmtDate, fmtMoney } from "@/lib/nexora/format";
import {
  DELIVERIES,
  driverName,
  FUEL_RECORDS,
...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <PageHeader title="Dashboard" description="Real-time overview of the NEXORA FLEET operation." />
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link href="/nexora/incidents" className="text-primary text-xs hover:underline">
              View all
            </Link>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link href="/nexora/maintenance" className="text-primary text-xs hover:underline">
              View all
            </Link>
          </CardHeader>
          <CardContent className="flex flex-col gap-3">
